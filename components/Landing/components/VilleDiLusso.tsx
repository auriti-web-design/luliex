            ...
            <div className='py-6'>
                <div className="p-8 lg:p-40 bg-[#D4B882]">
                    <div className='flex gap-4 lg:items-center items-center'>
                        ...
                        <h2 className='font-serif text-2xl lg:text-5xl text-secondary'>Ville di Lusso</h2>
                    </div>

                    <div className="text-lg lg:text-xl text-secondary leading-normal my-12">
                        <p>
                            Le <strong>ville di lusso</strong> sono immobili capaci di stregare chiunque cerchi una nuova casa dove trascorrere momenti felici e accumulare ricordi indimenticabili. Inoltre si configurano come <strong>asset di pregio</strong>che hanno un indiscusso valore a livello internazionale.</p>
