...
import FsSimage3 from "@/assets/223.webp";
                    ...
                    <div className='lg:col-span-1 w-full py-12 lg:py-0'>
                        <div className='flex flex-col lg:container gap-y-8'>
                            ...
                            <p className='text-normal lg:text-lg'>
                                Gli agenti immobiliari e gli operatori del settore che pubblicheranno all&apos;interno della nostra piattaforma, grazie alle più <span className="text-gold">efficaci strategie di comunicazione e marketing</span> garantite da Luliex e alle esclusive funzionalità e servizi offerti dal nostro sito, avranno la possibilità di evidenziare il proprio talento fornendo agli utenti finali una presentazione degli immobili di sicura efficacia che permetterà di <span className="text-gold">implementare il numero di vendite</span>, aumentando esponenzialmente il proprio fatturato.
                            </p>

                            <p className='text-normal lg:text-lg'>
                                Garantiamo, inoltre, attraverso delle features innovative un&apos;,esperienza di navigazione sul nostro sito <span className="text-gold">intuitiva e performante</span> finalizzata ad una celere individuazione degli immobili che possono essere di maggiore interesse per l&#39;end-user.
                            </p>
